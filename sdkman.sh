...
# install:- channel: stable; cliVersion: 5.18.0; cliNativeVersion: 0.1.3; api: https://api.sdkman.io/2
...
export SDKMAN_VERSION="5.18.0"
export SDKMAN_NATIVE_VERSION="0.1.3"
# infer platform
